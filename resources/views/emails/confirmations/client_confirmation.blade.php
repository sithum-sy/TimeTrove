    ...
    <div class="container" style="max-width: 600px; margin: 0 auto;">
        <div class="card mt-4 shadow-sm">
            ...
            <div class="card-body p-4">
                ...
                <p>Your service request with the details below has been confirmed:</p>
                <div class="table-responsive">
                    <table class="table table-striped">
                        <tbody>
                            ...
                            <tr>
                                <th scope="row" class="text-primary">Service Provider:</th>
                                <td>{{ $serviceRequest->serviceProvider->first_name }} {{ $serviceRequest->serviceProvider->last_name }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <p class="mt-4">Your security code for this service request is:
                <h5><strong>{{ $securityCode }}</strong></h5>
                </p>

                <p class="mt-4">Please check whether the security code matches with your service provider's for security concerns.</p>
